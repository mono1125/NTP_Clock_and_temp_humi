...
static const int segmentPins[] = {
    OSL_A, OSL_B, OSL_C, OSL_D, OSL_E, OSL_F, OSL_G,
};

static const int a_digPins[] = {
    A_OSL_DIG6, A_OSL_DIG5, A_OSL_DIG4, A_OSL_DIG3, A_OSL_DIG2, A_OSL_DIG1,
};

static const int b_digPins[] = {
    B_OSL_DIG6, B_OSL_DIG5, B_OSL_DIG4, B_OSL_DIG3, B_OSL_DIG2, B_OSL_DIG1,
};

static const int c_digPins[] = {
    C_OSL_DIG6, C_OSL_DIG5, C_OSL_DIG4, C_OSL_DIG3, C_OSL_DIG2, C_OSL_DIG1,
};
